...
public class AudioWidget {
    ...
    private Configuration prepareConfiguration(@NonNull Builder builder) {
        ...
        Drawable playlistDrawable = builder.playlistDrawable != null ? builder.playlistDrawable : ContextCompat.getDrawable(context, R.drawable.musicx_launcher);
        Drawable albumDrawable = builder.defaultAlbumDrawable != null ? builder.defaultAlbumDrawable : ContextCompat.getDrawable(context, R.drawable.musicx_launcher);
