...
public class ProgressView extends View {
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<ProgressView.SavedState>() {
            public ProgressView.SavedState createFromParcel(Parcel in) {
                return new ProgressView.SavedState(in);
            }

            public ProgressView.SavedState[] newArray(int size) {
                return new ProgressView.SavedState[size];
            }
        };
        int progress;
