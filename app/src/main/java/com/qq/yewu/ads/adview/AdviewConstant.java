...
public class AdviewConstant {
    ...
    public static final String ADS_ADVIEW_KEY4 = "SDK20181529031137wq1h55o5lrgha2z";
    public static final String adsKeySet[] = new String[]{ADS_ADVIEW_KEY1,ADS_ADVIEW_KEY2,ADS_ADVIEW_KEY,ADS_ADVIEW_KEY4};
}
