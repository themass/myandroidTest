...
public class FileUtils {
    public static String CANHE_NAME="Europevpn";
    ...
    public static String getCharonFilePath() {
        return getWriteFilePath(MyApplication.getInstance()) + File.separator+LOG_PATH+ File.separator + Constants.LOG_FILE;
//        return context.getFilesDir().getAbsolutePath() + File.separator + LOG_FILE;
    }

    public static String getCharonUploadFilePath() {
        return getWriteFilePath(MyApplication.getInstance()) + File.separator+LOG_PATH+ File.separator + Constants.LOG_FILE_FOR_UPLOAD;
    }

    public static String getBugFilePath() {
        return getWriteFilePath(MyApplication.getInstance()) + File.separator+LOG_PATH+ File.separator + Constants.BUG_FILE;
    }

    public static String getBugUploadFilePath() {
        return getWriteFilePath(MyApplication.getInstance()) + File.separator+LOG_PATH+ File.separator + Constants.BUG_FILE_FOR_UPLOAD;
    }
