...
public class City implements Parcelable {
    ...
    public String toString() {
        return "City [province=" + province + ", city=" + city + ", name=" + name + ", pinyin="
                + pinyin + ", py=" + py + ", phoneCode=" + phoneCode + ", areaCode=" + areaCode
                + ", postID=" + postID + ", refreshTime=" + refreshTime + ", isLocation="
                + isLocation + ", pubTime=" + pubTime + ", weatherInfoStr=" + weatherInfoStr + "]";
    }
