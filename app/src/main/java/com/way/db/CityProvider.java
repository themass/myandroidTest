...
public class CityProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.way.yahoo.provider.sex.Citys";// 授权
	...
	public static void createTmpCityTable(Context context) {
		SQLiteDatabase db = context.openOrCreateDatabase(
				WaySystemUtils.getDBFilePath(context), Context.MODE_PRIVATE, null);
	...
	public boolean onCreate() {
		mSqLiteDatabase = getContext().openOrCreateDatabase(
				WaySystemUtils.getDBFilePath(getContext()), Context.MODE_PRIVATE,
				null);
