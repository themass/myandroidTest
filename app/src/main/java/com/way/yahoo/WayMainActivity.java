...
public class WayMainActivity extends BaseActivity implements OnClickListener,
	...
	private String mShareEndStr = "（更多精彩在 http://sspacee.com ）";
	...
	protected void onResume() {
		...
		if (!mTmpCities.isEmpty()) {
			...
			if(PreferenceUtils.getPrefBoolean(this, FIRST_RUN_APP, true)){
				startActivity(new Intent(WayMainActivity.this, QueryCityActivity.class));
	...
	public void onClick(View v) {
		...
		case R.id.add_city_btn:
			startActivity(new Intent(WayMainActivity.this,
	...
	private void shareTo() {
		new AsyncTask<Void, Void, File>() {
			...
			protected void onPreExecute() {
				super.onPreExecute();
				dialog = WaySystemUtils.getCustomeDialog(WayMainActivity.this,
			...
			protected void onPostExecute(File result) {
				...
				dialog.dismiss();
				if (result == null) {
					Toast.makeText(WayMainActivity.this, R.string.share_fail,
				...
				try {
					info = WeatherSpider
						.getWeatherInfo(WayMainActivity.this, city.getPostID(), city.getWeatherInfoStr());
	...
	private void initMenuDrawer() {
		...
		mMenuDrawer.setMenuSize(Math.round(0.6f * WaySystemUtils
	...
	protected void onMenuItemClicked(int position, Item item) {
		...
		case Item.FEEDBACK_ID:
			startActivity(new Intent(WayMainActivity.this, FeedBackActivity.class));
			break;
		case Item.ABOUT_ID:
			startActivity(new Intent(WayMainActivity.this, AboutActivity.class));
			break;
