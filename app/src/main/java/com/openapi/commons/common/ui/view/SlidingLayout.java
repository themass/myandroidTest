...
public class SlidingLayout extends FrameLayout {
    ...
    private int mTouchDownInterceptX = 0;
    ...
    private void initView(Context context) {
        ...
        mLeftShadow = getContext().getDrawable(R.drawable.left_shadow);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                int minDownX = mTouchDownInterceptX == 0 ? (getWidth() / 10) : mTouchDownInterceptX;
                if (!isConsumed && mTouchDownX < minDownX && Math.abs(deltaX) > Math.abs(deltaY)) {
                    isConsumed = true;
                }
    ...
    public int getmTouchDownInterceptX() {
        return mTouchDownInterceptX;
    }

    public void setmTouchDownInterceptX(int mTouchDownInterceptX) {
        this.mTouchDownInterceptX = mTouchDownInterceptX;
    }
}
