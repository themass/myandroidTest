...
public class AdviewAdsManager {
    ...
    public static void init(Context context) {
        ...
        AdViewSpreadManager.getInstance(context).init(initConfig, AdviewConstant.adsKeySet);
        AdViewBannerManager.getInstance(context).init(initConfig, AdviewConstant.adsKeySet);
        AdViewInstlManager.getInstance(context).init(initConfig, AdviewConstant.adsKeySet);
        AdViewNativeManager.getInstance(context).init(initConfig, AdviewConstant.adsKeySet);
        AdViewVideoManager.getInstance(context).init(initConfig, AdviewConstant.adsKeySet);
    }
}
