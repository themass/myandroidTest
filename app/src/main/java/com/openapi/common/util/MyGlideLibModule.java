...
import com.openapi.yewu.net.OkHttpStack;
...
public class MyGlideLibModule extends LibraryGlideModule {
    ...
    public void registerComponents(Context context, Glide glide, Registry registry) {
        ...
        com.openapi.common.util.LogUtil.i("MyGlideModule reg OK");
    }
    ...
    public static class LoggingListener<T> implements RequestListener<T> {
        ...
        public boolean onLoadFailed(@Nullable GlideException e, Object o, Target<T> target, boolean b) {
            com.openapi.common.util.LogUtil.e(String.format("GLIDE-onException(%s, %s, %s, %s)", e, o, target, b), e);
            return false;
        }

        @Override
        public boolean onResourceReady(T t, Object o, Target<T> target, DataSource dataSource, boolean b) {
            com.openapi.common.util.LogUtil.i(String.format("GLIDE-onResourceReady(%s, %s, %s, %s, %s)", resource, o, target, dataSource.toString(), b));
            return false;
        }
    }
}