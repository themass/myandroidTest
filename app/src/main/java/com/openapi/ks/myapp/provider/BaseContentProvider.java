package com.openapi.ks.myapp.provider;

import android.net.Uri;
import android.text.TextUtils;

import com.openapi.commons.common.util.db.MyContentProvider;


public class BaseContentProvider extends MyContentProvider {

    public static final String AUTHORITY = "com.openapi.ks.moviefree1";
