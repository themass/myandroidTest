package com.openapi.ks.chatfree.ui.maintab.body;
 ...
 */
public class RecommendLocalFragment extends RecommendFragment {
    private static final String INDEX_TAG = "local_tag";
