...
public enum ImcState {
     ...
     */
    public static com.timeline.vpn.service.imc.ImcState fromValue(int value) {
        for (com.timeline.vpn.service.imc.ImcState state : com.timeline.vpn.service.imc.ImcState.values()) {
