...
public enum PrivateEnterpriseNumber {
     ...
     */
    public static com.timeline.vpn.service.imc.attributes.PrivateEnterpriseNumber fromValue(int value) {
        for (com.timeline.vpn.service.imc.attributes.PrivateEnterpriseNumber pen : com.timeline.vpn.service.imc.attributes.PrivateEnterpriseNumber.values()) {
            if (pen.mValue == value) {
                return pen;
            }
        }
