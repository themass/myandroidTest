...
public class RemediationInstruction implements Parcelable {
    public static final Creator<com.timeline.vpn.service.imc.RemediationInstruction> CREATOR = new Creator<com.timeline.vpn.service.imc.RemediationInstruction>() {

        @Override
        public com.timeline.vpn.service.imc.RemediationInstruction[] newArray(int size) {
            return new com.timeline.vpn.service.imc.RemediationInstruction[size];
        }

        @Override
        public com.timeline.vpn.service.imc.RemediationInstruction createFromParcel(Parcel source) {
            return new com.timeline.vpn.service.imc.RemediationInstruction(source);
        }
    };
     ...
     */
    public static List<com.timeline.vpn.service.imc.RemediationInstruction> fromXml(String xml) {
        List<com.timeline.vpn.service.imc.RemediationInstruction> instructions = new LinkedList<com.timeline.vpn.service.imc.RemediationInstruction>();
     ...
     * @throws IOException
     */
    private static void readInstructions(XmlPullParser parser, List<com.timeline.vpn.service.imc.RemediationInstruction> instructions) throws XmlPullParserException, IOException {
        ...
        while (parser.next() != XmlPullParser.END_TAG) {
            ...
            if (parser.getName().equals("instruction")) {
                com.timeline.vpn.service.imc.RemediationInstruction instruction = new com.timeline.vpn.service.imc.RemediationInstruction();
     ...
     * @throws IOException
     */
    private static void readInstruction(XmlPullParser parser, com.timeline.vpn.service.imc.RemediationInstruction instruction) throws XmlPullParserException, IOException {
     ...
     * @throws IOException
     */
    private static void readItems(XmlPullParser parser, com.timeline.vpn.service.imc.RemediationInstruction instruction) throws XmlPullParserException, IOException {
        while (parser.next() != XmlPullParser.END_TAG) {
            if (parser.getEventType() != XmlPullParser.START_TAG) {
                continue;
            }
