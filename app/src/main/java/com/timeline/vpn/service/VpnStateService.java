...
public class VpnStateService extends Service {
    ...
    private final LinkedList<com.timeline.vpn.service.imc.RemediationInstruction> mRemediationInstructions = new LinkedList<com.timeline.vpn.service.imc.RemediationInstruction>();
    private long mConnectionID = 0;
    private Handler mHandler;
    private VpnProfile mProfile;
    private State mState = State.DISABLED;
    private ErrorState mError = ErrorState.NO_ERROR;
    private com.timeline.vpn.service.imc.ImcState mImcState = com.timeline.vpn.service.imc.ImcState.UNKNOWN;
     ...
     * @return imc state
     */
    public com.timeline.vpn.service.imc.ImcState getImcState() {	/* only updated from the main thread so no synchronization needed */
        return mImcState;
    }
     ...
     *
     */
    public void setImcState(final com.timeline.vpn.service.imc.ImcState state) {
        notifyListeners(new Callable<Boolean>() {
            @Override
            public Boolean call() throws Exception {
                if (state == com.timeline.vpn.service.imc.ImcState.UNKNOWN) {
     ...
     */
    public List<com.timeline.vpn.service.imc.RemediationInstruction> getRemediationInstructions() {	/* only updated from the main thread so no synchronization needed */
    ...
    public void startConnection(final VpnProfile profile) {
        notifyListeners(new Callable<Boolean>() {
            ...
            public Boolean call() throws Exception {
                ...
                VpnStateService.this.mImcState = com.timeline.vpn.service.imc.ImcState.UNKNOWN;
                VpnStateService.this.mRemediationInstructions.clear();
                return true;
            }
        });
     ...
     */
    public void addRemediationInstruction(final com.timeline.vpn.service.imc.RemediationInstruction instruction) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
     ...
     * this Service.
     */
    static  public interface VpnStateListener {
