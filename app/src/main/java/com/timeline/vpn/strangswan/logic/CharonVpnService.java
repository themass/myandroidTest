...
package com.timeline.vpn.strangswan.logic;
...
import com.timeline.vpn.strangswan.logic.VpnStateService.ErrorState;
import com.timeline.vpn.strangswan.logic.VpnStateService.State;
import com.timeline.vpn.strangswan.logic.imc.ImcState;
import com.timeline.vpn.strangswan.logic.imc.RemediationInstruction;
import com.timeline.vpn.strangswan.ui.VpnManagerActivity;
import com.timeline.vpn.strangswan.utils.SettingsWriter;
...
public class CharonVpnService extends VpnService implements Runnable
{
	...
	{
		LogUtil.i("onStartCommand->initializeCharon");
//		BuilderAdapter builder = new BuilderAdapter("47.88.85.172", 0);
//		initializeCharon(builder, mLogFile, false);
		LogUtil.i("onStartCommand->initializeCharon end");
		if (intent != null)
		{
	...
	static
	{
		LogUtil.i("load lib sdk version=" + Build.VERSION.SDK_INT);
