...
import com.timeline.vpn.strangswan.logic.CharonVpnService;
import com.timeline.vpn.strangswan.logic.TrustedCertificateManager;
import com.timeline.vpn.strangswan.logic.VpnStateService;
import com.timeline.vpn.strangswan.logic.VpnStateService.State;
import com.timeline.vpn.strangswan.ui.VpnProfileListFragment.OnVpnProfileSelectedListener;

public class VpnManagerActivity extends BaseToolBarActivity implements OnVpnProfileSelectedListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.vpn_manager);
		getToolbar().setNavigationIcon(R.drawable.left);
		getToolbar().setNavigationOnClickListener(new View.OnClickListener(){
			@Override
			public void onClick(View v) {
				VpnManagerActivity.this.finish();
			}
		});
...
//		bar.setDisplayShowTitleEnabled(false);
	...
	{
		getMenuInflater().inflate(R.menu.vpn_manager, menu);
		return true;
	}
		...
		public Dialog onCreateDialog(Bundle savedInstanceState)
		{
			...
			return new Builder(getActivity())
				...
				.setPositiveButton(button, new DialogInterface.OnClickListener() {
					...
					{
						VpnManagerActivity activity = (VpnManagerActivity)getActivity();
