...
//        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) ((NaviItemViewHolder) holder).ivPhoto.getLayoutParams();
        Integer high = mPostCache.get(position);
        LogUtil.i("post = " + position + " h=" + high);
//        int high = cellSize+ DisplayUtil.dp2px(context, 10 * (a.nextInt(9) / 3 * 3));
