...
public class VideoPlayQiniuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_qiniu_video);
        ...
        mVideoView.setVideoPath(vo.actionUrl);
        ...
        public boolean onInfo(PLMediaPlayer plMediaPlayer, int what, int extra) {
            ...
            switch (what) {
                ...
                case PLMediaPlayer.MEDIA_INFO_VIDEO_FRAME_RENDERING:
                    LogUtil.i( "video frame rendering, ts = " + extra);
                    break;
                case PLMediaPlayer.MEDIA_INFO_AUDIO_FRAME_RENDERING:
                    LogUtil.i( "audio frame rendering, ts = " + extra);
                    break;
                case PLMediaPlayer.MEDIA_INFO_VIDEO_GOP_TIME:
                    LogUtil.i( "Gop Time: " + extra);
                    break;
                case PLMediaPlayer.MEDIA_INFO_SWITCHING_SW_DECODE:
                    LogUtil.i( "Hardware decoding failure, switching software decoding!");
                    break;
                case PLMediaPlayer.MEDIA_INFO_METADATA:
                    LogUtil.i( mVideoView.getMetadata().toString());
                    break;
    ...
    private PLMediaPlayer.OnBufferingUpdateListener mOnBufferingUpdateListener = new PLMediaPlayer.OnBufferingUpdateListener() {
        ...
        public void onBufferingUpdate(PLMediaPlayer plMediaPlayer, int precent) {
            LogUtil.i( "onBufferingUpdate: " + precent);
        }
    };
    ...
    private PLMediaPlayer.OnVideoSizeChangedListener mOnVideoSizeChangedListener = new PLMediaPlayer.OnVideoSizeChangedListener() {
        ...
        public void onVideoSizeChanged(PLMediaPlayer plMediaPlayer, int width, int height) {
            LogUtil.i( "onVideoSizeChanged: width = " + width + ", height = " + height);
        }
    };
    ...
    private PLMediaPlayer.OnVideoFrameListener mOnVideoFrameListener = new PLMediaPlayer.OnVideoFrameListener() {
        ...
        public void onVideoFrameAvailable(byte[] data, int size, int width, int height, int format, long ts) {
            LogUtil.i( "onVideoFrameAvailable: " + size + ", " + width + " x " + height + ", " + format + ", " + ts);
        }
    };
    ...
    private PLMediaPlayer.OnAudioFrameListener mOnAudioFrameListener = new PLMediaPlayer.OnAudioFrameListener() {
        ...
        public void onAudioFrameAvailable(byte[] data, int size, int samplerate, int channels, int datawidth, long ts) {
            LogUtil.i( "onAudioFrameAvailable: " + size + ", " + samplerate + ", " + channels + ", " + datawidth + ", " + ts);
        }
    };
    ...
    private void showToastTips(final String tips) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mToast = Toast.makeText(VideoPlayQiniuActivity.this, tips, Toast.LENGTH_SHORT);
                mToast.show();
            }
        });
    }
