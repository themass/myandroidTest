...
import com.timeline.vpn.adapter.VideoListAdapter;
...
//        recyclerView.addOnScrollListener
    ...
    protected InfoListVo<RecommendVo> loadData(Context context) throws Exception {
        return indexService.getInfoListData(Constants.getPage_URL(Constants.API_VIDEO_ITEMS_URL, infoListVo.pageNum), RecommendVo.class, TAG);
    }
}
