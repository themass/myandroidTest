...
package com.timeline.vpn.logic;
...
import com.timeline.vpn.logic.imc.RemediationInstruction;
import com.timeline.vpn.logic.utils.SettingsWriter;
...
//        return context.getFilesDir().getAbsolutePath() + File.separator + LOG_FILE;
    ...
    public class BuilderAdapter {
        ...
        private Builder createBuilder(String name) {
            ...
            Intent intent = new Intent(context, TabIndexFragment.class);
