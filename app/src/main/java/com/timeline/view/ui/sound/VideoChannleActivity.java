...
import com.timeline.view.ui.fragment.body.VideoChannleBodyFragment;
...
public class VideoChannleActivity extends BaseFragmentActivity {
    ...
    public void setupView() {
        ...
        if(AdsContext.rateShow())
            AdsManager.getInstans().showInterstitialAds(this, AdsContext.Categrey.CATEGREY_VPN3,false);
    }
}
