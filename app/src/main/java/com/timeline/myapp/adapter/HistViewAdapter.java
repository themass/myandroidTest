 ...
 */
public class HistViewAdapter extends BaseRecyclerViewAdapter<HistViewAdapter.ItemtView, HistVo> {
    public HistViewAdapter(Context context, RecyclerView recyclerView, List<HistVo> data, OnRecyclerViewItemClickListener<HistVo> listener) {
    ...
    public static class ItemtView extends BaseRecyclerViewAdapter.BaseRecyclerViewHolder<HistVo> {
        @Nullable
