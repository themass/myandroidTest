package com.sspacee.yewu.ads.youmi;
        ...
        final View bannerView = BannerManager.getInstance(context)
                .getBannerView(context, new BannerViewListener() {
                    ...
                    public void onRequestSuccess() {
                        ...
                        msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_BANNER, BaseAdsController.AdsShowStatus.ADS_READY_MSG, BaseAdsController.AdsFrom.YOUMI);
                    ...
                    public void onRequestFailed() {
                        Message msg = Message.obtain();
                        msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_BANNER, BaseAdsController.AdsShowStatus.ADS_NO_MSG, BaseAdsController.AdsFrom.YOUMI);
                        handler.sendMessage(msg);
                    }
                });
        if (bannerView != null) {
            ...
            SpotManager.getInstance(mContext)
                    .showSplash(mContext, splashViewSettings, new SpotListener() {
                        ...
                        public void onShowSuccess() {
                            Message msg = Message.obtain();
                            msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_SPREAD, BaseAdsController.AdsShowStatus.ADS_READY_MSG, BaseAdsController.AdsFrom.YOUMI);
                            handler.sendMessage(msg);
                        }
                        ...
                        public void onShowFailed(int errorCode) {
                            Message msg = Message.obtain();
                            msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_SPREAD, BaseAdsController.AdsShowStatus.ADS_NO_MSG, BaseAdsController.AdsFrom.YOUMI);
                            handler.sendMessage(msg);
                        ...
                        public void onSpotClosed() {
                            Message msg = Message.obtain();
                            msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_SPREAD, BaseAdsController.AdsShowStatus.ADS_DISMISS_MSG, BaseAdsController.AdsFrom.YOUMI);
                            handler.sendMessage(msg);
                        }
                        ...
                        public void onSpotClicked(boolean isWebPage) {
                            Message msg = Message.obtain();
                            msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_SPREAD, BaseAdsController.AdsShowStatus.ADS_CLICK_MSG, BaseAdsController.AdsFrom.YOUMI);
                            handler.sendMessage(msg);
                        }
                    });
        } catch (Exception e) {
        ...
        try {
            SpotManager.getInstance(context)
                    .showSlideableSpot(context, new SpotListener() {
                        ...
                        public void onShowSuccess() {
                            Message msg = Message.obtain();
                            msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_INTERSTITIAL, BaseAdsController.AdsShowStatus.ADS_READY_MSG, BaseAdsController.AdsFrom.YOUMI,score);
                            handler.sendMessage(msg);
                        }
                        ...
                        public void onShowFailed(int errorCode) {
                            Message msg = Message.obtain();
                            msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_INTERSTITIAL, BaseAdsController.AdsShowStatus.ADS_NO_MSG, BaseAdsController.AdsFrom.YOUMI,score);
                            handler.sendMessage(msg);
                        ...
                        public void onSpotClosed() {
                            Message msg = Message.obtain();
                            msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_INTERSTITIAL, BaseAdsController.AdsShowStatus.ADS_DISMISS_MSG, BaseAdsController.AdsFrom.YOUMI);
                            handler.sendMessage(msg);
                        }
                        ...
                        public void onSpotClicked(boolean isWebPage) {
                            Message msg = Message.obtain();
                            msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_INTERSTITIAL, BaseAdsController.AdsShowStatus.ADS_CLICK_MSG, BaseAdsController.AdsFrom.YOUMI);
                            handler.sendMessage(msg);
                        }
                    });
        } catch (Exception e) {
            LogUtil.e(e);
            Message msg = Message.obtain();
            msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_INTERSTITIAL, BaseAdsController.AdsShowStatus.ADS_NO_MSG, BaseAdsController.AdsFrom.YOUMI);
            handler.sendMessage(msg);
        }
    }
    @Override
        ...
        try {
            View nativeSpotView = SpotManager.getInstance(context)
                    .getNativeSpot(context, new SpotListener() {
                        ...
                        public void onShowSuccess() {
                            Message msg = Message.obtain();
                            msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_NATIVE_INTERSTITIAL, BaseAdsController.AdsShowStatus.ADS_READY_MSG, BaseAdsController.AdsFrom.YOUMI);
                            handler.sendMessage(msg);
                        }
                        ...
                        public void onShowFailed(int errorCode) {
                            Message msg = Message.obtain();
                            msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_NATIVE_INTERSTITIAL, BaseAdsController.AdsShowStatus.ADS_NO_MSG, BaseAdsController.AdsFrom.YOUMI);
                            handler.sendMessage(msg);
                        ...
                        public void onSpotClosed() {
                            Message msg = Message.obtain();
                            msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_NATIVE_INTERSTITIAL, BaseAdsController.AdsShowStatus.ADS_DISMISS_MSG, BaseAdsController.AdsFrom.YOUMI);
                            handler.sendMessage(msg);
                        }
                        ...
                        public void onSpotClicked(boolean isWebPage) {
                            Message msg = Message.obtain();
                            msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_NATIVE_INTERSTITIAL, BaseAdsController.AdsShowStatus.ADS_CLICK_MSG, BaseAdsController.AdsFrom.YOUMI);
                            handler.sendMessage(msg);
                        }
                    });
                ...
                .getNativeVideoAdView(context,
                        ...
                        new VideoAdListener() {
                            ...
                            public void onPlayStarted() {
                                ...
                                Message msg = Message.obtain();
                                msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_NATIVE_VEDIO, BaseAdsController.AdsShowStatus.ADS_READY_MSG, BaseAdsController.AdsFrom.YOUMI);
                                handler.sendMessage(msg);
                            }
...
//                                }
                            ...
                            public void onPlayFailed(int errorCode) {
                                Message msg = Message.obtain();
                                msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_NATIVE_VEDIO, BaseAdsController.AdsShowStatus.ADS_NO_MSG, BaseAdsController.AdsFrom.YOUMI);
                                handler.sendMessage(msg);
                            ...
                            public void onPlayCompleted() {
                                Message msg = Message.obtain();
                                msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_NATIVE_VEDIO, BaseAdsController.AdsShowStatus.ADS_FINISH_MSG, BaseAdsController.AdsFrom.YOUMI);
                                handler.sendMessage(msg);
//                                if (videoInfoViewBuilder != null) {
//                                    videoInfoViewBuilder.release();
//                                }
    ...
    public void offerAds(Context context,final Handler handler){
        ...
        OffersManager.getInstance(context).showOffersWall(new Interface_ActivityListener() {
            ...
            public void onActivityDestroy(Context context) {
                Message msg = Message.obtain();
                msg.obj = new BaseAdsController.AdsMsgObj(BaseAdsController.AdsType.ADS_TYPE_OFFER, BaseAdsController.AdsShowStatus.ADS_DISMISS_MSG, BaseAdsController.AdsFrom.YOUMI);
                handler.sendMessage(msg);
