...
public class Extras {
    ...
    /*private SharedPreferences MyApplication.getmPreferences();
    private SharedPreferences MyApplication.getMetaData();
    private static Context context;*/
    private static Extras instance;

    public Extras() {
        //context = contexts;
        //MyApplication.getmPreferences() = PreferenceManager.getDefaultSharedPreferences(context);
        //MyApplication.getMetaData() = context.getSharedPreferences(TAG_METADATA, MODE_PRIVATE);
    }
    ...
    public SharedPreferences getmPreferences() {
        return MyApplication.getmPreferences();
    }
    ...
    public String getSongSortOrder() {
        return MyApplication.getmPreferences().getString(SONG_SORT_ORDER, SortOrder.SongSortOrder.SONG_A_Z);
    }
    ...
    public String getArtistSortOrder() {
        return MyApplication.getmPreferences().getString(ARTIST_SORT_ORDER, SortOrder.ArtistSortOrder.ARTIST_A_Z);
    }
    ...
    public String getAlbumSortOrder() {
        return MyApplication.getmPreferences().getString(ALBUM_SORT_ORDER, SortOrder.AlbumSortOrder.ALBUM_A_Z);
    }
    ...
    public String getArtistAlbumSort() {
        return MyApplication.getmPreferences().getString(ARTIST_ALBUM_SORT, SortOrder.ArtistAlbumSortOrder.ALBUM_A_Z);
    }
    ...
    public String getPlaylistSort() {
        return MyApplication.getmPreferences().getString(PLAYLIST_SORT_ORDER, SortOrder.PlaylistSortOrder.PLAYLIST_A_Z);
    }

    ////////////////////////// Preferences /////////////////////////

    public void setwidgetPosition(int pos) {
        SharedPreferences.Editor sharededitor = MyApplication.getmPreferences().edit();
    ...
    public int getwidgetPositionX() {
        return MyApplication.getmPreferences().getInt(KEY_POSITION_X, 100);
    }

    public int getwidgetPositionY() {
        return MyApplication.getmPreferences().getInt(KEY_POSITION_Y, 100);
    }

    public String getTabIndex() {
        return MyApplication.getmPreferences().getString(REORDER_TAB, "0");
    }
    ...
    public boolean saveLyrics() {
        return MyApplication.getmPreferences().getBoolean(SaveLyrics, true);
    }

    public boolean songView() {
        return MyApplication.getmPreferences().getBoolean(GridViewSong, false);
    }

    public boolean albumView() {
        return MyApplication.getmPreferences().getBoolean(GridViewAlbum, false);
    }

    public boolean artistView() {
        return MyApplication.getmPreferences().getBoolean(GridViewArtist, false);
    }

    public boolean floatingWidget() {
        return MyApplication.getmPreferences().getBoolean(FloatingView, false);
    }

    public String fontConfig() {
        return MyApplication.getmPreferences().getString(TextFonts, "11");
    }

    public boolean headsetConfig() {
        return MyApplication.getmPreferences().getBoolean(SaveHeadset, true);
    }

    public boolean phonecallConfig() {
        return MyApplication.getmPreferences().getBoolean(SaveTelephony, true);
    }
    ...
    public boolean saveData() {
        return MyApplication.getmPreferences().getBoolean(SAVE_DATA, true);
    }

    public boolean hideNotify() {
        return MyApplication.getmPreferences().getBoolean(HIDE_NOTIFY, false);
    }

    public boolean hideLockscreen() {
        return MyApplication.getmPreferences().getBoolean(HIDE_LOCKSCREEEN, false);
    }

    public boolean restoreLastTab() {
        return MyApplication.getmPreferences().getBoolean(RESTORE_LASTTAB, false);
    }

    public boolean hqArtistArtwork() {
        return MyApplication.getmPreferences().getBoolean(HQ_ARTISTARTWORK, false);
    }

    public boolean artworkColor() {
        return MyApplication.getmPreferences().getBoolean(ARTWORKCOLOR, false);
    }

    public String getFadeDuration() {
        return MyApplication.getmPreferences().getString(FADEINOUT_DURATION, "0");
    }

    public boolean getFadeTrack() {
        return MyApplication.getmPreferences().getBoolean(FADETRACK, false);
    }

    public boolean getWigetColor(){
        return MyApplication.getmPreferences().getBoolean(WIDGET_COLOR, false);
    }

    public boolean getHdArtwork() {
        return MyApplication.getmPreferences().getBoolean(HD_ARTWORK, false);
    }

    public boolean getDownloadedArtwork(){
        return MyApplication.getmPreferences().getBoolean(DOWNLOADED_ARTWORK, false);
    }

    public String getAudioFilter(){
        return MyApplication.getmPreferences().getString(AUDIO_FILTER, "0");
    }

    public String getBlurView() {
        return MyApplication.getmPreferences().getString(BlurView, "2");
    }
    ...
    public String getFolderPath() {
        return MyApplication.getmPreferences().getString(FOLDERPATH, Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC).getPath());
    }
    ...
    public int getCurrentpos() {
        return MyApplication.getmPreferences().getInt(CURRENTPOS, 0);
    }

    public int getRepeatMode(int repeatmode) {
        return MyApplication.getmPreferences().getInt(REPEATMODE, repeatmode);
    }

    public boolean getShuffle(boolean shuffle) {
        return MyApplication.getmPreferences().getBoolean(SHUFFLEMODE, shuffle);
    }

    public boolean getState(boolean state) {
        return MyApplication.getmPreferences().getBoolean(PLAYINGSTATE, state);
    }

    public String getSongTitle(String songtitle) {
        return MyApplication.getmPreferences().getString(SONG_TITLE, songtitle);
    }

    public String getSongArtist(String artist) {
        return MyApplication.getmPreferences().getString(SONG_ARTIST, artist);
    }

    public long getSongId(long id) {
        return MyApplication.getmPreferences().getLong(SONG_ID, id);
    }

    public long getAlbumId(long albumid) {
        return MyApplication.getmPreferences().getLong(SONG_ALBUM_ID, albumid);
    }

    public String getSongPath(String path) {
        return MyApplication.getmPreferences().getString(SONG_PATH, path);
    }
    ...
    public void saveMetaData(Song song) {
        SharedPreferences.Editor editor = MyApplication.getMetaData().edit();
    ...
    public String getTitle() {
        return MyApplication.getMetaData().getString(SONG_TITLE, null);
    }

    public String getArtist() {
        return MyApplication.getMetaData().getString(SONG_ARTIST, null);
    }

    public String getAlbum() {
        return MyApplication.getMetaData().getString(SONG_ALBUM, null);
    }

    public String getPath() {
        return MyApplication.getMetaData().getString(SONG_PATH, null);
    }

    public int getNo() {
        return MyApplication.getMetaData().getInt(SONG_TRACK_NUMBER, 0);
    }

    public long getAlbumID() {
        return MyApplication.getMetaData().getLong(SONG_ALBUM_ID, 0);
    }

    public long getId() {
        return MyApplication.getMetaData().getLong(SONG_ID, 0);
    }

    public String getYear() {
        return MyApplication.getMetaData().getString(SONG_YEAR, null);
    }
    ...
    public int getAlbumGrid() {
        return MyApplication.getmPreferences().getInt(ALBUMGRID, 2);
    }
    ...
    public int getArtistGrid() {
        return MyApplication.getmPreferences().getInt(ARTISTGRID, 2);
    }
    ...
    public int getSongGrid() {
        return MyApplication.getmPreferences().getInt(SONGGRID, 2);
    }
    ...
    public boolean getWidgetTrack() {
        return MyApplication.getmPreferences().getBoolean(WIDGETTRACK, false);
    }
    ...
    public boolean getSettings(){
        return MyApplication.getmPreferences().getBoolean(SETTINGS_TRACK, false);
    }
    ...
    public long getPlaylistId() {
        return MyApplication.getmPreferences().getLong(PLAYLIST_ID, 0);
    }
    ...
    public ArrayList<Integer> getRemoveTab() {
        String s = MyApplication.getmPreferences().getString(REMOVE_TABLIST, "");
    ...
    public String getTypeface(){
        return MyApplication.getmPreferences().getString(TRYPEFACE_PATH, Typeface.DEFAULT.toString());
    }
    ...
    public boolean getPlayingViewTrack(){
        return MyApplication.getmPreferences().getBoolean(PLAYINGVIEW_TRACK, false);
    }
    ...
    public Boolean getNavSettings() {
        return MyApplication.getmPreferences().getBoolean(NAV_SETTINGS, false);
    }
