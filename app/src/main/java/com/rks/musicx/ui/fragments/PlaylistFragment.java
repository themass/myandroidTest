...
public class PlaylistFragment extends BaseRefreshFragment {
    ...
    private LoaderCallbacks<List<Song>> playlistLoader = new LoaderCallbacks<List<Song>>() {
        @Override
    ...
    private BaseRecyclerViewAdapter.OnItemClickListener mOnclick = (position, view) -> {
        ...
        switch (view.getId()) {
            case R.id.item_view:
                ((MusicXMainActivity) getActivity()).onSongSelected(playlistViewAdapter.getSnapshot(), position);
                break;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.shuffle_all:
                ((MusicXMainActivity) getActivity()).onShuffleRequested(playList, true);
                break;
        }
