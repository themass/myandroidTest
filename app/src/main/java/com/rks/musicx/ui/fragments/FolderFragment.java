                        ...
                        case R.id.item_view:
                            if (currentPath != null) {
                                if (currentPath.isDirectory()) {
                                    ...
                                    if (index > -1) {
                                        ((MusicXMainActivity) getActivity()).onSongSelected(folder.getSongList(), index);
        ...
        switch (item.getItemId()) {
            case R.id.shuffle_all:
                if (folderAdapter.getSongList().size() > 0) {
                    ((MusicXMainActivity) getActivity()).onShuffleRequested(folderAdapter.getSongList(), true);
                } else {
