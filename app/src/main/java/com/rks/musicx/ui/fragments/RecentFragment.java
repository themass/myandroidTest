...
public class RecentFragment extends BaseLoaderFragment {
    ...
    private BaseRecyclerViewAdapter.OnItemClickListener onClick = new BaseRecyclerViewAdapter.OnItemClickListener() {
        ...
        public void onItemClick(int position, View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.item_view:
                    ((MusicXMainActivity) getActivity()).onSongSelected(recentlyPlayed.getSnapshot(), position);
                    break;
    ...
    protected void funtion() {
        ...
        RecentlyAddedMore.setOnClickListener(v -> {
            ((MusicXMainActivity) getActivity()).setFragment(recentlyAddedFragment);
        });
        More.setOnClickListener(v -> {
            ((MusicXMainActivity) getActivity()).setFragment(recentPlayedFragment);
        });
