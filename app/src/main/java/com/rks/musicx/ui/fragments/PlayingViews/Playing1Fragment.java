...
import static com.openapi.ks.moviefree1.R.id.lyrics;
...
public class Playing1Fragment extends BasePlayingFragment implements SimpleItemTouchHelperCallback.OnStartDragListener {
    ...
    public static void startFragment(Context context) {
        ...
        intent.putExtra(CommonFragmentActivity.FRAGMENT, Playing1Fragment.class);
    ...
    protected void ui(View rootView) {
        ...
        coverView = LayoutInflater.from(getActivity()).inflate(R.layout.playing1_coverview, null, false);
        View lyricsView = LayoutInflater.from(getActivity()).inflate(R.layout.lyricsview, null, false);
        ...
        pagerAdapter = new PlayingPagerAdapter(getActivity().getSupportFragmentManager(), Playing3PagerDetails);
