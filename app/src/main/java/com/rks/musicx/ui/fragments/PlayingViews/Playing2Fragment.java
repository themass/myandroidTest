...
import static com.openapi.ks.moviefree1.R.id.song_artist;
import static com.openapi.ks.moviefree1.R.id.song_title;
...
public class Playing2Fragment extends BasePlayingFragment implements SimpleItemTouchHelperCallback.OnStartDragListener {
    ...
    protected void ui(View rootView) {
        ...
        PlayingPagerAdapter = new PlayingPagerAdapter(getActivity().getSupportFragmentManager(),Playing4PagerDetails);
