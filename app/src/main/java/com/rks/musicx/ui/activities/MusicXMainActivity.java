...
public class MusicXMainActivity extends BaseActivity implements MetaDatas, ATEActivityThemeCustomizer, NavigationView.OnNavigationItemSelectedListener {
    ...
    private void openFile(Uri data) {
        List<Song> playList = Helper.getSongMetaData(MusicXMainActivity.this, data.getPath());
        if (playList.size() > 0) {
    ...
    protected void function() {
        ...
        permissionManager.checkPermissions(MusicXMainActivity.this);
        if (!Extras.getInstance().getWidgetTrack()) {
            permissionManager.widgetPermission(MusicXMainActivity.this);
        }
        // TODO li 屏蔽设定铃声权限
//        if (!Extras.getInstance().getSettings()){
//            permissionManager.settingPermission(MusicXMainActivity.this);
//        }
        ateKey = returnAteKey();
        accentcolor = Config.accentColor(this, ateKey);
        primarycolor = Config.primaryColor(this, ateKey);
        if (mNavigationView != null) {
            mNavigationView.setNavigationItemSelectedListener(MusicXMainActivity.this);
        }
        count = Extras.getInstance().getInitValue(MusicXMainActivity.this, "first", "last");
        if (count == 0) {
            Intent intent = new Intent();
            intent.setClass(MusicXMainActivity.this, IntroActivity.class);
            startActivity(intent);
            count++;
            Extras.getInstance().setInitValue(MusicXMainActivity.this, count, "first", "last");
        }
        songDetail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MusicXMainActivity.this, PlayingActivity.class);
        ...
        mRequestManager = Glide.with(MusicXMainActivity.this);
        ...
        ShortcutsHandler.create(MusicXMainActivity.this);
        SongTitle.setTypeface(Helper.getFont(MusicXMainActivity.this));
        SongArtist.setTypeface(Helper.getFont(MusicXMainActivity.this));
        songProgressHandler = new Handler(Looper.getMainLooper());
        progressRunnable = new ProgressRunnable(MusicXMainActivity.this);
        helper = new Helper(this);
        pause = ContextCompat.getDrawable(MusicXMainActivity.this, R.drawable.aw_ic_pause);
        play = ContextCompat.getDrawable(MusicXMainActivity.this, R.drawable.aw_ic_play);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuInflater menuInflater = new MenuInflater(MusicXMainActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.system_eq:
                ...
                if (intent.getAction() != null && Helper.isActivityPresent(MusicXMainActivity.this, intent)){
    ...
    private void multiQueuePlay() {
        ...
        savedQueue = Helper.getSavedQueueList(MusicXMainActivity.this);
        if (savedQueue == null) {
            return;
        }
                    ...
                    public boolean onSelection(MaterialDialog dialog, Integer[] which, CharSequence[] text) {
                        if (dialog.getItems() != null) {
                            ...
                            for (CharSequence name : text) {
                                CommonDatabase commonDatabase = new CommonDatabase(MusicXMainActivity.this, name.toString(), true);
                                queueList.clear();
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.action_sleep_timer:
                        if (!Sleeptimer.running) {
                            Sleeptimer.showSleepTimer(MusicXMainActivity.this);
                        } else {
                            Sleeptimer.showTimerInfo(MusicXMainActivity.this);
                        }
                        break;
                    case R.id.action_eq:
                        Helper.startActivity(MusicXMainActivity.this, EqualizerActivity.class);
                        break;
                    case R.id.action_settings:
                        Extras.getInstance().setNaviSettings(false);
                        Helper.startActivity(MusicXMainActivity.this, SettingsActivity.class);
                        break;
                    case R.id.action_donation:
                        Helper.startActivity(MusicXMainActivity.this, DonationActivity.class);
                        break;
                    case R.id.about:
                        Helper.startActivity(MusicXMainActivity.this, AboutActivity.class);
                        break;
                    case R.id.shares:
                        ...
                        break;
                    case R.id.rateus:
                        Helper.showRateDialog(MusicXMainActivity.this);
                        break;
            ...
            public void run() {
                if (Extras.getInstance().getDownloadedArtwork()) {
                    mRequestManager.load(helper.loadAlbumImage(musicXService.getsongAlbumName()))
                            ...
                            .centerCrop()
                            .placeholder(R.drawable.musicx_launcher)
                            .error(R.drawable.musicx_launcher)
                            .format(DecodeFormat.PREFER_ARGB_8888)
                            .override(300, 300)
                            .listener(GlidePalette.with(ArtworkUtils.getAlbumCoverPath(MusicXMainActivity.this, musicXService.getsongAlbumName()).getAbsolutePath())
                                    .intoCallBack(new BitmapPalette.CallBack() {
                                        @Override
                                        public void onPaletteLoaded(@Nullable Palette palette) {
                                            int color[] = Helper.getAvailableColor(MusicXMainActivity.this, palette);
                            ...
                            .into(new SimpleTarget<Bitmap>() {
                                ...
                                public void onLoadFailed(Drawable errorDrawable) {
                                    ArtworkUtils.blurPreferances(MusicXMainActivity.this, ArtworkUtils.drawableToBitmap(errorDrawable), BackgroundArt);
                                }

                                @Override
                                public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                                    ArtworkUtils.blurPreferances(MusicXMainActivity.this, resource, BackgroundArt);
                                }
    ...
    private static class ProgressRunnable implements Runnable {
        ...
        private final WeakReference<MusicXMainActivity> activityWeakReference;

        public ProgressRunnable(MusicXMainActivity myClassInstance) {
            activityWeakReference = new WeakReference<MusicXMainActivity>(myClassInstance);
        }

        @Override
        public void run() {
            MusicXMainActivity musicXMainActivity = activityWeakReference.get();
            if (musicXMainActivity != null)
                musicXMainActivity.updateProgress();
