...
struct charonservice_t {
     ...
     */
    bool (*update_status)(charonservice_t *
     ...
     * @return				TRUE on success
     */
    bool (*update_imc_state)(charonservice_t *
     ...
     * @return				TRUE on success
     */
    bool (*add_remediation_instr)(charonservice_t *
     ...
     */
    bool (*bypass_socket)(charonservice_t *
     ...
     *						NULL on failure
     */
    linked_list_t *(*get_trusted_certificates)(charonservice_t *
     ...
     *						NULL on failure
     */
    linked_list_t *(*get_user_certificate)(charonservice_t *
     ...
     */
    private_key_t *(*get_user_key)(charonservice_t *
     ...
     */
    vpnservice_builder_t *(*get_vpnservice_builder)(charonservice_t *
     ...
     */
    network_manager_t *(*get_network_manager)(charonservice_t *
