...
METHOD(kernel_ipsec_t, get_spi, status_t,
        private_kernel_android_ipsec_t
*this,
host_t *src, host_t
*dst,
u_int8_t protocol, u_int32_t
*spi)
{
return ipsec->sas->
get_spi(ipsec
->sas, src, dst, protocol, spi);
}
...
host_t *src, host_t
*dst,
u_int32_t spi, u_int8_t
protocol,
u_int32_t reqid, mark_t
mark,
...
return ipsec->sas->
add_sa(ipsec
->sas, src, dst, spi, protocol, reqid, mark,
...
host_t *new_dst,
        bool
encap,
bool new_encap, mark_t
mark)
{
return ipsec->sas->
update_sa(ipsec
->sas, spi, protocol, cpi, src, dst,
...
mark_t mark,
        u_int64_t
*bytes,
u_int64_t *packets, time_t
*time)
{
return ipsec->sas->
query_sa(ipsec
->sas, src, dst, spi, protocol, mark,
bytes, packets, time);
}
...
u_int32_t spi, u_int8_t
protocol,
u_int16_t cpi, mark_t
mark)
{
return ipsec->sas->
del_sa(ipsec
->sas, src, dst, spi, protocol, cpi, mark);
}
...
*dst_ts,
policy_dir_t direction, policy_type_t
type,
ipsec_sa_cfg_t *sa, mark_t
mark,
policy_priority_t priority
)
{
return ipsec->policies->
add_policy(ipsec
->policies, src, dst, src_ts,
...
traffic_selector_t *src_ts,
        traffic_selector_t
*dst_ts,
policy_dir_t direction, u_int32_t
reqid,
mark_t mark, policy_priority_t
priority)
{
return ipsec->policies->
del_policy(ipsec
->policies, src_ts, dst_ts,
...
{
return charonservice->
bypass_socket(charonservice, fd, family
);
}
