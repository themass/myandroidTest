...
METHOD(network_manager_t, add_connectivity_cb,
void,
private_network_manager_t *this, connectivity_cb_t
cb,
void *data
)
{
...
METHOD(network_manager_t, remove_connectivity_cb,
void,
private_network_manager_t *this, connectivity_cb_t
cb)
{
...
METHOD(network_manager_t, destroy,
void,
