...
METHOD(imc_state_t, set_flags,
void,
private_imc_android_state_t *this, bool
has_long,
bool has_excl
)
{
...
METHOD(imc_state_t, set_max_msg_len,
void,
private_imc_android_state_t *this, u_int32_t
max_msg_len)
{
this->
...
METHOD(imc_state_t, change_state,
void,
private_imc_android_state_t *this, TNC_ConnectionState
new_state)
{
this->
state = new_state;
...
METHOD(imc_state_t, set_result,
void,
private_imc_android_state_t *this, TNC_IMCID
id,
TNC_IMV_Evaluation_Result result
)
{
...
METHOD(imc_state_t, get_result, bool,
        private_imc_android_state_t
*this,
TNC_IMCID id, TNC_IMV_Evaluation_Result
*result)
{
if (result)
{
