...
{
DBG1(DBG_NET,
"receiving DNS response failed: %s",
strerror(errno)
);
}
return
...
lib->watcher->
add(lib
->watcher, skt->fd, WATCHER_READ, handle_response,
skt);
lib->scheduler->
schedule_job(lib
->scheduler,
(job_t*)
callback_job_create(handle_timeout, skt,
        NULL, (callback_job_cancel_t)
return_false), SOCKET_TIMEOUT);
}
skt->
last_use = time_monotonic(NULL);
if (
sendto(skt
->fd, data.ptr, data.len, 0, dst->
get_sockaddr(dst),
        *dst
->
...
METHOD(android_dns_proxy_t, register_cb,
void,
private_android_dns_proxy_t *this, dns_proxy_response_cb_t
cb,
void *data
)
{
...
METHOD(android_dns_proxy_t, unregister_cb,
void,
private_android_dns_proxy_t *this, dns_proxy_response_cb_t
cb)
{
...
METHOD(android_dns_proxy_t, add_hostname,
void,
...
METHOD(android_dns_proxy_t, destroy,
void,
private_android_dns_proxy_t *this
)
{
