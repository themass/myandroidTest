...
*,
private_android_creds_t *this, certificate_type_t
cert,
key_type_t key,
        identification_t
*id,
...
enumerator = this->creds->set.create_cert_enumerator(&this->creds->set,
                                                     cert, key, id, trusted);
return
enumerator_create_cleaner(enumerator, (
void*)this->lock->unlock,
this->lock);
}

METHOD(android_creds_t, add_username_password,
void,
...
this->creds->
add_shared(this
->creds, shared_key, id, NULL);
}

METHOD(credential_set_t, create_shared_enumerator, enumerator_t
*,
private_android_creds_t *this, shared_key_type_t
type,
...
*,
private_android_creds_t *this, key_type_t
type,
identification_t *id
)
{
...
METHOD(android_creds_t, destroy,
void,
private_android_creds_t *this
)
{
